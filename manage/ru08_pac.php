...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ru08_pac.php"><?php echo $g5['title']?></a></li>
		</div>
	...
	<div class="business_type5" class="area">
		...
		<ul>
			<li>
				<dl>
					<dt>
						<img src="./image/EAC26_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC24_Ex_PAC1.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC27_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC17_Ex_sgr.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC18_Ex_sgr.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC28_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<!----li>
				<dl>
					...
					<dd>
						<strong>RUST-TEST PACIFIC CB Safety</strong>
