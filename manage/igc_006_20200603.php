...
<div class="content_wrap">
	...
	<section class="partner_type2">
		<div class="txt">
		 <span style="color:#1698de;">러시아 RCU EAC 인증 개요</span><br>
           ...
           TRCU는 Technical Regulation of Customs Union의 약어로 러시아를 중심으로 한 관세동맹(Customs Union)의 기술규정을 의미합니다. TRCU는 2010년 러시아, 카자흐스탄, 벨라루스 3개국이 결성한 유라시안 관세동맹 “EACU, Eurasian Customs Union”을 시작으로, 2015년 유라시안 경제연합 “EEU, Eurasian Economic Union”에서 발효 한 통합 인증제도입니다. 현재 유라시안 관세동맹/경제연합은 러시아, 카자흐스탄, 벨라루스, 키르기스스탄, 아르메니아 총 5개국으로 결성되어있으며, TRCU인증은 유라시안 경제 위원회 결정을 따라 규정된 인증절차를 따릅니다.
           </p>
		...
		<div class="con_area">
			...
			<div class="txtArea">
				...
				<ul>
					<li><a href="russia/ru01_trcueac.php"><span><div  class="arrow test_4"></div>러시아 TRCU EAC</span></a></li>
					<li><a href="russia/ru01_trcueac.php"><span><div  class=""></div></span></a></li>
					<!-----li>
        ...
        <div class="con_area">
			...
			<div class="txtArea">
				<!----p class="tit">보건 및 안전 - 1라인 우측</p------>
				<ul>
					<li><a href="ru02_gostrr.php"><span><div  class="arrow test_4"></div>러시아 GOST R</span></a></li>
