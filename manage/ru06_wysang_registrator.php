...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ru06_wysang_registrator.php"><?php echo $g5['title']?></a></li>
		</div>
...
<div class="content_wrap">
	<div class="page_title">
		...
		<h2 class="sub_txt">러스테스트 퍼스픽의 러시아 위생등록 사업영역</h2>
	</div>
...
국가위생등록은 식품과 화장품의 경우 발행 요구대상이 될 수 있습니다.<br class="sn"> <br><br><br>
		...
		<ul>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC15_Ex_sgr.jpg">
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC14_Ex_sgr.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC16_Ex_sgr.png">
					</dt>
					<dd>
