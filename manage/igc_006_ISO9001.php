...
<div class="content_wrap">
	...
	<section class="business_type5" class="area">
		<h1><span style="font-family: georgia;">ISO</span> 9001</h1>
		<h2>품질경영시스템 인증</h2>		
		...
		<ul>
			<li>
				<dl>
					<dt>
						<img src="./image/ISO_9001_01.jpg" alt="ISO 9001 요구사항">
					</dt>
					<dd>
			...
			<li>
				<dl>
					...
					<dd>
						<strong><span style="font-family: georgia;">IGC</span>의 역량</strong>
...
<br><br><br><br><br><br>
	...
	<section class="partner_type2" style="font-size:1.5em;text-align:justify;margin-right:10px;display:inline-block;">
		...
		<div class="con_box">
		<span style="font-family: georgia;">IGC</span>는 다음과 같은 인증 및 관련 서비스를 제공하고 있습니다. <br>특히, <span style="font-family: georgia;">ISO</span> 45001은 <span style="font-family: georgia;">ISO</span> 9001, <span style="font-family: georgia;">ISO</span> 14001과 통합 인증이 가능합니다.<br><br><br>
