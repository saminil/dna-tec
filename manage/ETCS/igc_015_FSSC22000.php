...
$g5['title'] = '품질경영인증-ISO9001';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조-------> 
...
<div class="content_wrap">
	...
	<section class="business_type5" class="area">
		<h1>품질경영인증 - ISO 9001</h1>
		<h2>Your 1st Business Partner</h2>		
		<h3>
			IGC인증원는 빠르게 변화하는 웹환경에 <br class="sn">발 맞추어 다양한 기술을 습득하고,<br>
			한발 앞서 고객의 눈높이에 맞는 서비스로 <br class="sn">고객만족을 넘어서 고객 감동을 실현하겠습니다.<br>
			IGC인증원를 아껴주시는 고객 여러분께 <br class="sn">깊은 감사의 말씀 드리며, <br class="sn">앞으로도 객님의 말씀에 귀 기울이며<br>
			웹기술을 선도하는 IGC인증원가 되도록 <br class="sn">최선을 다하겠습니다.
		</h3>
		<ul>
			<li>
				<dl>
					<dt>
						<img src="../image/business_img5.jpg">
					</dt>
					<dd>
						<strong>글로벌 경영인증 시스템</strong>
						<p>이곳은 간략한 설명글이 들어갈 자리입니다.</p>
						<p>이곳은 간략한 설명글이 들어갈 자리입니다.</p>
						<p>이곳은 간략한 설명글이 들어갈 자리입니다.</p>
					</dd>
				</dl>
