...
$g5['title'] = 'ISO/IEC 20000-1 : 서비스경영시스템';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조-------> 
			...
			<li>
				<dl>
					...
					<dd>
						...
						<span style="font-family:georgia;font-size:1.2em;text-align:justify;margin-right:10px;display:inline-block;">
                       <!---------------------
                       오늘날의 서비스 부문 중심 경제에서 점점 더 많은 회사들이 <span style="font-family: georgia;">ISO</span> 9001을 비즈니스 도구로 사용하고 있습니다. 적절하게 명시된 품질 목표, 고객 만족도 조사 및 지속적인 개선 프로그램을 통해 기업은 효율성과 수익성을 높일 수 있습니다. <br>
                        즉, 적절한 품질 관리는 비즈니스를 향상 시키며, 투자, 시장 점유율, 매출 성장, 매출 마진, 경쟁 우위 및 소송 회피에 긍정적인 영향을 미칩니다. 
                        ---------------->
                        <br>
                          a) 서비스 품질 향상<br><br>
