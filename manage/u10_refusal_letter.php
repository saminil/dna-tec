<?php 	
	...
	$g5['title'] = "Rejection Letter"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
	<div class="page_title">
		...
		<h2 class="sub_txt">RUS-TEST PACIFIC</h2>
	</div>
	...
	<div class="business_type5" class="area">
		...
		<ul>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC31_01_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC32_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC33_Ex_PAC.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/RejectionLetter_document02.jpg">
					</dt>
					<dd>
