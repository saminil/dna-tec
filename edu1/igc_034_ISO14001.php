...
$g5['title'] = '환경';//<!------서브페이지 최상위 타이블, css/design.css 파일 Line 425 ~ line 430까지 참조-------> 
...
<div class="content_wrap">
	<section class="page_title">
		<h1 class="sub_tit" style="font-family:georgia;">ISO 14001 환경<span class="fc_pointer"> 심사원 교육</span> </h1>
		<h2 class="sub_txt">경쟁력과 능력을 갖추기 위하여 기업과 산업체는 적격성을 갖춘 심사원을 필요로 합니다.</h2>
	</section>
	<section class="vision_type5">
		...
		<h2 class="title"><span style="font-family:georgia;">ISO</span> 14001 교육</h2>
		<ul>
			<li>
				<div class="i_box">
					<div class="icon" style="display:inline-block;background-image:url(./images/iso_14001_01.jpg);background-repeat:no-repeat;overflow:hidden;display:flex;align-items:center:justify-content:center;with:auto;height:332px;"><i class="fas fa-hands-helping"></i><em><!------ EDUCATION ---------></em></div>
				</div>
				<div class="con_txt">
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
						ISO 14001:2015는 환경경영시스템(EMS)를 위한 국제 규격이며, 이는 전 세계적으로 가장 많이 사용되는 EMS 규격입니다. 한국 내 많은 기업들이 조직의 환경경영 위해 인증을 받고 있으며, 전 세계적으로는 25만개 이상의 인증서가 발행되고 있습니다. 
						<br><br>
						경쟁력과 능력을 갖추기 위하여 기업과 산업체는 적격성을 갖춘 심사원을 필요로 합니다. ISO 14001 경영 시스템 심사원 인증 프로그램 (ISO 14001 프로그램)의 목적은 이 프로그램을 통해 인증 받은 심사원이 적격하며, 인증원과 기업 및 산업 분야에 신뢰성을 제공하기 위함입니다. 
					</span>
					<br><br>
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
		...
		<div class="vision_area">
		<h2 class="title">ISO 14001 이란?</h2>
		<ul>
			<li>
				<div class="i_box">
					<div class="icon"><i class="fas fa-microscope"></i><em>ISO 14001 <br>심사원 교육</em></div>
				</div>
				<div class="con_txt">
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
						ISO 14001은 기업의 환경측면을 통제하고, 환경영향을 감소시키며, 법규 준수를 보장합니다.<br>
                        ISO 14001은 환경경영시스템에 대한 원칙, 시스템 및 지원 기술에 관한 일반 가이드라인을 동반합니다. 이 규격은 환경경영시스템 수립, 시행, 유지 및 개선과 같은 이슈들을 다룹니다.
					</span>
				</div>
			</li>
		</ul>
		...
		<div class="vision_area">
		<h2 class="title"><span style="font-family:georgia;">ISO</span> 14001의 중요성</h2>
		<ul>
			<li>
				<div class="i_box">
				...
				<div class="con_txt">
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
						ISO 14001에 대한 신뢰성을 가지기 위해서 인증원은 적격한 심사원을 필요로 합니다. 환경경영시스템 심사원 인증 프로그램의 목적은 심사원으로서 필요한 지식을 제공하는 것이며 본 프로그램을 통해 교육된 심사원은 적격성이 있다 라는 것을 산업계에 제공하는데 있습니다. 
					</span><br><br>
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
		...
		<div class="vision_area">
		<h2 class="title" style="font-family:georgia;">IGC인증원의 역량</h2>
		<ul>
			<li>
				<div class="i_box">
				...
				<div class="con_txt">
					<span style="margin:0 auto;display:inline-block;text-align:justify;">
						1. IGC는 IAF MLA 개인인증 승인기관인 GPC와의 협력을 바탕으로 ISO 14001 선임심사원 교육 및 인증서 발행에 대한 서비스를 제공합니다. <br><br>
						2. GPC는 인증분야 최상위 기관인 IAF(International Accreditation Forum)로부터 <br>
						국제적 상호인정 협약을 체결한 미국 소재의 인정기관인 IAS(International Accreditation Service)로부터 
						ISO/IEC 17024를 기준으로 인정을 받은 개인인증기관입니다. <br><br>
						3. GPC는 IAF로부터 개인인증에 대한 업무를 인정받은 최초의 기관인 IPC와 MLA를 체결한 정회원 기관으로, IAS 인정 스킴과 별개로 자체적인 인증서 발행이 가능하게 되었습니다.<br><br>
					</span>>
				</div>
			</li>
		</ul>
		...
		<!----(주)아이지씨인증원 사업영역 시작-------->
	         <section class="partner_type2">
                <h2 class="con_arrow">
	         	...
	         	<div class="con_box">
	         		<ul>
	         		IGC는 ISO 14001 전 과정에 대한 서비스를 제공합니다.<br><br>
	         			<li><p><em><strong>01</strong></em><span style="font-family:georgia;">ISO</span> 14001 시스템 인증</p></li>
	         			<li style="float:none"><p><em><strong>02</strong></em><span style="font-family:georgia;">ISO</span> 14001 교육 가능 연수기관 안내</p></li>
	         			<li><p><em><strong>03</strong></em><span style="font-family:georgia;">ISO</span> 14001 심사원 인증</p></li>
	         			<br><br>
	         		</ul>
	         	</div>
	         	<div class="con_box">
