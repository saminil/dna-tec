...
<style>
	...
	.business_type3 .business_info .backImg:nth-child(1){background:url('images/product_medical_divice_registration_01.jpg') no-repeat center top; }
	.business_type3 .business_info .backImg:nth-child(2){background:url('images/product_medical_divice_registration_05.jpg') no-repeat center top; }
	.business_type3 .business_info .backImg:nth-child(3){background:url('images/product_medical_divice_registration_03.jpg') no-repeat center top; }
	.business_type3 .business_info .backImg:nth-child(4){background:url('images/product_medical_divice_registration_04.jpg') no-repeat center top; }
    .business_type3 .business_info .backImg:nth-child(5){background:url('images/product_medical_divice_registration_02.jpg') no-repeat center top; }
    .business_type3 .business_info .backImg:nth-child(6){background:url('images/product_medical_divice_registration_06.jpg') no-repeat center top; }
