...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<?php if($tmenu2_){?><li><a href="uz_gostus.php"><?php echo $tmenu2_?></a></li><?php }?><!----2Depth 러시아 페이지 연결-------->
			<li><a href="uz_gostus.php"><?php echo $g5['title']?></a></li>
		</div>
...
<style>
	...
	.business_type4 .business_info .img_left { position:absolute; left:0; top:0; width:500px; height:700px; background:blue; }
	.business_type4 .business_info .img_left img{ width:100%; height:100%;}
	.business_type4 .business_info .img_right { position:absolute; right:0; top:0; width:500px; height:500px; background:blue; }
...
<div class="content_wrap">
	<div class="page_title">
		...
		<!----h2 class="sub_txt" style="text-align:left;"><strong>GOST UZ 개요</strong><br>GOST UZ는 우즈베키스탄의 해당 규정에 적합하는지를 증명하는 인증이며, 현재 우즈베키스탄은 유라시안 관세동맹에 가입하지 않은 국가이기 때문에 TR CU 인증서가 아닌 GOST UZ 인증서를 발급받아야 합니다.</h2------->
		<!------img src="./image/Logo_GOST UZ.jpg" alt="GOST UZ 인증마크" style="display:block;width:25%;margin-left:auto;margin-right:auto;"----->
		<!------h2 class="sub_txt" style="text-align:center;">GOST UZ 인증 마크</h2----->	
	</div>
     ...
     <h1>GOST UZ 개요</h1>
		<h3 style="text-align:left;">
			TGOST UZ는 우즈베키스탄의 해당 규정에 적합하는지를 증명하는 인증이며, 현재 우즈베키스탄은 유라시안 관세동맹에 가입하지 않은 국가이기 때문에 TR CU 인증서가 아닌 GOST UZ 인증서를 발급받아야 합니다.
			<!----
    ...
    <div class="business_info" style="height:700px;">
			<div class="img_left">
			<img src="./image/GOST_Uz02.jpg" style="height:100%"><br><br><br><br>
			<!----img src="./image/GOST_Uz03.jpg" style="height:100%"--------->
			</div>
			<div class="con_box">
				<div class="txt_area" style="word-break:keep-all;">
				<strong style="color:#1F88E5;">GOST UZ 인증서 유형</strong>
	 ...
	 <br><br><br><br> <br><br><br><br> <br><br><br><br> <br><br><br><br> <br><br><br><br> <br><br><br><br><br><br><br><br>			
		...
		<div class="business_info">
			<div class="img_left"><img src="./image/GOST_Uz04.jpg" style="height:100%"></div>
			<div class="con_box">
				<div class="txt_area">
