...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ka05_measuring_equipment.php"><?php echo $g5['title']?></a></li>
		</div>
...
<style>
    ...
    /*.business_type2 .business_info ul li.left_box1 { float:left; width:500px; height:1200px; overflow:hidden; }*/
    ...
    .business_type2 .business_info ul li.right_box1{position:relative; float:right; width:50%; height:650px;}
	...
	.business_type2 .business_info ul li.right_box .txt03 span {display:block; padding:20px 25px; height:200px; }
...
<div class="content_wrap">
	...
	<div class="business_type2">
		...
		<ul>
			<li class="left_box" style="height:50%;"><img src="./image/pac_k07.jpg" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="../russia/image/EAC24_Ex_PAC1.jpg" alt="이미지"></li>
			<li class="right_box1">
				<div class="txt_area">
					<div class="txt01">
