...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ka02_gostk.php"><?php echo $g5['title']?></a></li>
		</div>
...
<div class="content_wrap">
           ...
           <li class="left_box">
			    <dt>
				  <div id="eac_CoC" style="width:50%;margin-left:auto;margin-right:auto;">
						<img src="./image/GOST_K_01.jpg"><br><br>
	...
	<div class="business_type2">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="./image/GOST_K_00.jpg" alt="카자흐스탄 TRCU EAC"></li><br>
		...
		<ul>
		<br>
			<li class="left_box" style=""><img src="./image/GOST_K_02.jpg" alt="카자흐스탄 GOST K"><br></li>
		...
		<div class="business_info">
		<ul>
			<li class="left_box"><img src="./image/GOST_K_03.jpg" alt="카자흐스탄 GOST K"><br></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box"><img src="./image/GOST_K_04.png" alt="카자흐스탄 TRCU EAC"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
						<p><span class="tit">GOST K 인증 절차</span></p>
						<!-----p><span class="txt">GOST K는 카자흐스탄 KAZMEMST (Committee for Standardization, Metrology and Certification)에서 승인한 인증기관에서 발행 가능하며 규정 상 다음의 품목이 GOST K 인증 대상입니다.</span></p---->
                        <!----p>TRCU(Technical Regulation of Customs Union)유라시안 관세동맹국가 간 발효 된 통합 인증제도의 도입 후 카자흐스탄 내 GOST K 인증 품목은 크게 줄어들었습니다. 하지만 아직 동맹국 간 협의가 이루어지지 않은 강제 인증 품목에 한해서는 수입통관 시 GOST K 인증이 요구됩니다.</p--->
					</div>
					<div class="txt02">
					<ul>
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="../russia/image/EAC18_Ex_sgr.jpg" alt="카자흐스탄 TRCU EAC"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<ul>
			...
			<li>
				<div class="txt_area">
					...
					<div class="txt02">
					<!----ul>
						<li>GOST K CoC (강제 적합성 인증)</li>
						<li>GOST K Voluntary CoC (자발적 적합성 인증)</li>
					</ul---->
					</div>
				</div>
				<!-----div class="txt03">
