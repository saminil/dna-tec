...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ka02_bangpok_audits.php"><?php echo $g5['title']?></a></li>
		</div>
...
<div>
	...
	<div class="business_type2">
		...
		<ul>
			<li class="left_box" style="height:40%;"><img src="../russia/image/EAC03_Ex_CoC.jpg" alt="TRCU EAC Ex 대상 품목"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box"><img src="./image/02_2.jpg" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<ul>
			<li class="left_box" style="height:30%;"><img src="../kazahstan/image/EAC02_Ex_CoC.png" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:30%;">
			   <img src="../russia/image/EAC04_Ex_CoC.jpg" alt="이미지">
            </li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:40%;"><img src="./image/02_1.jpg" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="../russia/image/EAC06_Ex_CoC.png" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="../russia/image/EAC18_Ex_sgr.jpg" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
		...
		<div class="business_info">
		<ul>
			<li class="left_box" style="height:50%;"><img src="../russia/image/EAC08_Ex_CoC.jpg" alt="이미지"></li>
			<li class="right_box">
				<div class="txt_area">
					<div class="txt01">
