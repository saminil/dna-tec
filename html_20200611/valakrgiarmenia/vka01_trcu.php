...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<?php if($tmenu2_){?><li><a href="vka01_trcu.php"><?php echo $tmenu2_?></a></li><?php }?><!----러시아 페이지 연결-------->
			<li><a href="vka01_trcu.php"><?php echo $g5['title']?></a></li>
		</div>
...
<style>
	...
	.business_type5 ul li dl dt img{max-width:100%; margin:0 auto;width:100%px;}	
    ...
    /* 고객님께 드리는 혜택 시작  */
    .business_type5 .txt_area { width:100%; padding-top:40px; border-top:2px solid #000; }
	.business_type5 .txt_area:after{content:""; display:block; clear:both;}
	.business_type5 .txt_area .txt01 { float:left; width:100%; word-break: keep-all; }
	.business_type5 .txt_area .txt01 p { padding:0; margin:0; margin-bottom:15px; padding:0;}
	.business_type5 .txt_area .txt01 span.tit { display:block; font-size:2.2em; color:#000; font-weight:700; line-height:1.2em;  }
	.business_type5 .txt_area .txt01 span.txt { display:block; font-size:1.15em; color:#333; font-weight:400; line-height:1.4em; }
	.business_type5 .txt_area .txt02 { float:left; width:100%; margin-top:20px;}
	.business_type5 .txt_area .txt02 ul {margin:0; padding:0; }
	.business_type5 .txt_area .txt02 ul li { position:relative; color:#555; font-weight:400; line-height:1.5em; list-style:none; padding-left:3%; margin-bottom:5px;}
	.business_type5 .txt_area .txt02 ul li:before {position:absolute; top:8px; left:0; content:""; display:inline-block; width:4px; height:4px; background:#555; margin-right:10px; vertical-align:middle;}

    .business_type5 .con_arrow{ width:100%; max-width:1200px;  padding-bottom:20px;  margin:0 auto;}
	.business_type5 .con_arrow p{position:relative; font-size:1.2em; color:#000; padding-left:30px; text-align:left;}
	.business_type5 .con_arrow span{  position:absolute; right:0; display:inline-block; font-size: 1em;  padding-left: 10px;  color: #555;}
	.business_type5 .con_arrow > p:before{position:absolute; top:4px; left:10px; display:inline-block; content:""; width:3px; height:23px; background-color:#1F88E5; -ms-transform:rotate(45deg); -webkit-transform:rotate(45deg); -moz-transform:rotate(45deg); -o-transform:rotate(45deg); transform:rotate(45deg);}

	.business_type5 .con_box{ width:100%; padding:20px 0; border-top:1px solid #000; border-bottom:1px solid #000;}
	.business_type5 .con_box:after{content:""; display:block; clear:both;}
	.business_type5 .con_box ul { padding:0; margin:0; }
	.business_type5 .con_box ul li {float:left; width:100%; list-style:none; margin:10px 0; }
	.business_type5 .con_box ul li p{display:table; width:100%; }
	.business_type5 .con_box ul li p > em, .business_type2 .con_box p > span{display:table-cell; vertical-align:top; }
	.business_type5 .con_box ul li p > em{ width:30px; }
	.business_type5 .con_box ul li p > em > strong{display:inline-block; width:30px; height:30px;  line-height:30px; color:#fff; background-color:#000; text-align:center; font-size:1em;  border-radius:100%; -moz-border-radius:100%; -webkit-border-radius:100%; -o-border-radius:100%; font-weight:500;}
	.business_type5 .con_box ul li p > span{font-size:1em; line-height:30px; color:#555; letter-spacing:-0.75px;  padding:0 15px;}
    /* 고객님께 드리는 혜택 종료  */
...
<div class="content_wrap">
	<div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer">TRCU EAC</span>인증 벨라루스, 키르기스스탄, 아르메니아</h1>
		<h2 class="sub_txt">RUS-TEST PACIFIC의 벨라루스, 키르기스스탄, 아르메니아 사업영역</h2>
	</div>
	
	<div class="business_type5" class="area">
		<h1>TRCU EAC 인증서 개요</h1>
		<h3 style="text-align:left;">
			TRCU는 Technical Regulation of Customs Union의 약어로 러시아를 중심으로 한 관세동맹(Customs Union)의 기술규정을 의미합니다.<br class="sn">TRCU는 2010년 러시아, 카자흐스탄, 벨라루스 3개국이 결성한 유라시안 관세동맹 “EACU, Eurasian Customs Union”을 시작으로, 2015년 유라시안 경제연합 “EEU, Eurasian Economic Union”에서 발효 한 통합 인증제도입니다.<br>
			현재 유라시안 관세동맹/경제연합은 러시아, 카자흐스탄, 벨라루스, 키르기스스탄, 아르메니아 총 5개국으로 결성되어있으며,  <br class="sn">현재 유라시안 관세동맹/경제연합은 러시아, 카자흐스탄, 벨라루스, 키르기스스탄, 아르메니아 총 5개국으로 결성되어있으며, TRCU인증은 유라시안 경제 위원회 결정을 따라 규정된 인증절차를 따릅니다.  <br>
			...
			<li>
				<dl>
				    ...
				    <dt>
						...
						<div id="eac_CoC2"><img src="./image/02_2.jpg" style="display:block;margin-left:auto;margin-right:auto;"><br>
						 <p style="text-align:center;">RCU EAC 인증서</p>
						</div>	
                        
                         <br><br><br><br><br><br><br><br><br><br><br><br><br><br>
						
						<div id="eac_CoC2"><img src="./image/01_2.jpg" style="display:block;margin-left:auto;margin-right:auto;"><br>
						 <p style="text-align:center;">RCU EAC 인증서</p>
						</div>		
	...
	<!--------------/ TRCU 관계법령 종료 /----------------------->
			...
			<li>
			 <br><br>
				<dl>
					<dt>
						<div id="eac_CoC"><img src="../russia/image/eac_mark03_CoC.png" style="display:block;margin-left:auto;margin-right:auto;"><br>
						 <p style="text-align:center;">TRCU EAC 인증서-TRCU CoC</p>
						</div>	
						<br><br><br>
						
						<div id="eac_CoC2"><img src="../russia/image/eac_mark04_DoC.png" style="display:block;margin-left:auto;margin-right:auto;"><br>
					...
					<dd>
                        ...
                        <p>TRCU 인증서는 세부사항에 따라 적합성인증(CoC, Certification of Conformity)과 적합성선언(DoC, Declaration of Conformity) 두 가지로 분류됩니다.<br>
                           <span style="color:#1F88E5">- TRCU CoC</span> : 
                                 압력 용기류, 수공구류, 크레인, 승강기, 일부 기계류, 시험장비, 전기전자제품 등의 제품군이 해당되며, 샘플시험 또는 공장심사가 요구됩니다.<br><br><br><br><br><br><br><br><br><br><br>
                           <span style="color:#1F88E5">- TRCU DoC</span> : 
                                 비교적 위험성이 작은 일반 제품에 해당되며 일부 제품은 서류심사만으로 인증서 발급이 가능합니다.</p><br>
			...
			<br><br>
			    ...
			    <strong style="font-size:1.5em;">&nbsp; &nbsp; &nbsp; 유라시아 인증 신청자</strong>
                <p><!--------------------></p>
				<dl>
					<!-----dt><img src="../image/circle_bg1.png">  </dt------->
					<dd>
						<!-----strong>TRCU 관계 법령</strong----->
						<p>TRCU인증, GOST R인증 등 경우 러시아 또는 기타 관세동맹 국가에서 위치한 업체만 신청자가 될 수 있습니다. 그 업체는 법적 실체 또는 개인사업자여야 하며 일반인은 인증의 신청자가 될 수 없습니다.
                RUS-TEST PACIFIC은 유라지아 지역 내에 신청자 역할을 할 수 있는 사업자가 없는 고객을 위해 Eurasia Representative 서비스를 제공하고 있습니다.</p>
					</dd>
				</dl>
			</li>
	        <br><br><br>
        ...
        <ul>
			<li>
			<br><br>
			    <strong style="font-size:1.5em;">&nbsp; &nbsp; &nbsp; Rosakkreditasiya 대장(Register)</strong>
                <!------p>TRCU 인증, GOST R 인증 등 경우 러시아 또는 기타 관세동맹 국가에서 위치한 업체만 신청자가 될 수 있습니다. 그 업체는 법적실체 또는 개인사업자여야 하며 일반인은 인증의 신청자가 될 수 없습니다.
                        RUST-TEST PACIFIC은 유라지아 지역 내에 신청자 역할을 할 수 있는 사업자가 없는 고객을 위해 Eurasia Representative 서비스를 제공하고 있습니다.</p------><br>
			    
				<dl>
					<!------dt><img src="../image/circle_bg1.png"  style="display:block;width:250px;">  </dt-----> 
					<dd>
						<!----strong>TRCU 관계 법령</strong------>
						<p>TRCU인증, GOST R인증 등 경우 러시아 또는 기타 관세동맹 국가에서 위치한 업체만 신청자가 될 수 있습니다. 그 업체는 법적 실체 또는 개인사업자여야 하며 일반인은 인증의 신청자가 될 수 없습니다.
                        RUS-TEST PACIFIC은 유라지아 지역 내에 신청자 역할을 할 수 있는 사업자가 없는 고객을 위해 Eurasia Representative 서비스를 제공하고 있습니다.</p>
						...
						<!----strong>TRCU 관계 법령</strong------>
						<p style="display:block;margin-left:80px;color:#3e91e9;"><a href="https://www.fsa.gov.ru/">Rosakkreditasiya 웹사이트 바로가기 Click!!</a> </p> <br><br>
			</li>       
        </ul>
