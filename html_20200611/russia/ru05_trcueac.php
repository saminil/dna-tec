...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ru05_trcueac.php"><?php echo $g5['title']?></a></li>
		</div>
	...
	<div class="business_type5" class="area">
		...
		<ul>
			<li>
				<dl>
					<dt>
						<img src="./image/EAC10_Ex_trcueac.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC11_Ex_trcueac.jpg">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC12_Ex_trcueac.png">
					</dt>
					<dd>
