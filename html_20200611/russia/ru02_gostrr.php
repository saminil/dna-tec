<?php 	
	...
	$g5['title'] = "GOST R"; //커스텀페이지의 타이틀을 입력합니다.
...
?>
	...
	<div id="sub_tit">
		<div class="path">
			...
			<li><a href="ru02_gostrr.php"><?php echo $g5['title']?></a></li>
...
<div class="content_wrap">
	...
	<div class="business_type5" class="area">
		<!---h1>러시아 고스트 | GOST R</h1---->
		<!---h2>GOST 인증서 종류</h2--->
        <!----
		<h3>
			러스테스트 퍼스픽는 빠르게 변화하는 웹환경에 <br class="sn">발 맞추어 다양한 기술을 습득하고,<br>
			한발 앞서 고객의 눈높이에 맞는 서비스로 <br class="sn">고객만족을 넘어서 고객 감동을 실현하겠습니다.<br>
			러스테스트 퍼스픽를 아껴주시는 고객 여러분께 <br class="sn">깊은 감사의 말씀 드리며, <br class="sn">앞으로도 객님의 말씀에 귀 기울이며<br>
