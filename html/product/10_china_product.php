<?php 	
	...
	$tmenu2_ = "중국"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "중국"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">중국 인증</span></h1>
            <h2 class="sub_tit2">
                CFDA, 식품위생등록 – 중국으로 화장품을 수출하고자 하는 기업은 중국의 식품약품감독관리총국인 CFDA에 등록해야만 중국으로의 정식판매가 가능합니다.
            </h2>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/product/images/product_china_cfda_01.jpg" style="width: 70%"></p>
            <div class="txt03" style="text-align:justify">
                <span>
                    <ul style="width: 80%;margin: 0 auto">
                        <li>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;CFDA</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;식품 위생 등록</div>
                        </li>
                    </ul>
                </span>
            </div>
