<?php 	
	...
	$tmenu2_ = "동남아시아"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "동남아시아"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">동남아시아 인증</span></h1>
            <div class="sub_txt">
                <p><strong class="point_b1">태국 의료기기 등록</strong></p>
				<p>
				    태국에서 의료기기를 제조, 수입 및 유통하기 위해서는 태국 식약청(FDA)에 사전 등록하여 허가를 받아야 합니다. 태국 식약청은 의료기기를 일반 의료기기, 신고 의료기기, 허가 의료기기 세 가지로 분류하고 있습니다.
				</p><br><br>
				<p><strong class="point_b1">대만 의료기기 등록</strong></p>
				<p>
				    대만으로 의료기기를 수출하기 위해서는 보건 당국인 대만 보건부의 승인을 받아야 합니다.
				</p>
            </div>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/product/images/product_tailand_00.jpg" style="width: 70%"></p>
	    </div>
