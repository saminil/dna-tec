<?php 	
	...
	$tmenu2_ = "식품 & 화장품"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "식품 & 화장품"; //커스텀페이지의 타이틀을 입력합니다.
...
<style>
    ...
    .txt03{ width:80%; margin: 0 auto; border-top:1px solid #ddd; font-size:1em; color:#555; line-height:1.5em; text-transform: uppercase; background:#f8f8f8; overflow:hidden;margin-bottom: 50px}
    ...
    .logo_location {width: 90%;text-align: center;margin: 70px auto}
    .logo_location img {width: 40%;}
    .sub_txt {width: 90%;margin: 70px auto;text-align: justify}
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">식품 &amp; 화장품 인증</span></h1>
            <div class="sub_txt">
                <p><strong class="point_b1">Vegan (식품)</strong></p>
				<p>
				    동물 유래 원재료를 사용하지 않고 제품에 동물실험을 실시하지 않는 기준을 통해 부여하는 인증제도입니다.
				</p><br><br>
				<p><strong class="point_b1">Halal (식품)</strong></p>
				<p>
                ...
                <p><strong class="point_b1">EWG (화장품)</strong></p>
				<p>
				    1992년 미국 환경단체 EWG (Environmental Working Group)에서 만든 화장품 성분 안전도 등급입니다.
				</p><br><br>
				<p><strong class="point_b1">CPNP (화장품)</strong></p>
				<p>
            ...
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/product/images/product_cosmetics_ewg_01.png"></p>
	    </div>
