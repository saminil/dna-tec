<?php 	
	...
	$tmenu2_ = "미주"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "미주"; //커스텀페이지의 타이틀을 입력합니다.
...
<style>
    ...
    .logo_location img {width: 40%;margin-bottom: 70px}
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">미주 인증</span></h1>
            <h2 class="sub_tit2">
                미국 연방 식품 의약국 FDA(food and drug administration)는 미국 보건 복지부 (US Department Health and human service) 산하 기관으로 미국에서 생산 또는 수입되어 판매되는 의료기기, 의약품, 식품, 건강 보조 식품, 화장품 등에 대해 검사하고 규제하고 있으며, 기업은 미국으로 수출하고자 하는 제품을 등록하여야 합니다
            </h2>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/product/images/product_FDA_01.jpg" style="width: 70%"></p>
            <div class="txt03" style="text-align:justify">
                <span>
                    <ul style="width: 80%;margin: 0 auto">
                        <li><strong>FDA 제품 등록 품목은 다음과 같습니다.</strong><br><br>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;FDA</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;의료기기</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;전자 및 방사선 장치</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;의약품</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;식음료품</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;건강보조식품</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;화장품</div>
                        </li>
                    </ul>
                </span>
            </div>
