<?php 	
	...
	$tmenu2_ = "유라시아"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "유라시아"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">유라시아 인증</span></h1>
            <h2 class="sub_tit2">
                유라시아 지역으로 제품을 수출하고자 하는 기업은 해당 기술규정에 따른 적합성 준수를 증명하는 인증을 받아야 하며 제품, 포장 또는 첨부 문서에 적합성 마크를 표시해야 해당 국가로 수출이 가능합니다.
            </h2>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/product/images/product_eactrcu_01.png" style="width: 70%"></p>
            <div class="txt03" style="text-align:justify">
                <span>
                    <ul style="width: 80%;margin: 0 auto">
                        <li><strong>유라시아 인증 기술규정은 다음과 같습니다.</strong><br><br>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;TRCU EAC인증</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;GOST인증</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;EAC Ex 방폭 인증</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;의료기기&amp;의약품 등록</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;식품 위생등록</div>
                            <div style="text-indent: 1.2em;">-&nbsp;&nbsp;화장품 위생등록</div>
                        </li>
                    </ul>
                </span>
            </div>
