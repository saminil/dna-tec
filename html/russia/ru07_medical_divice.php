	...
	<div class="business_type5" class="area">
		...
		<ul>
			<li>
				<dl>
					<dt> <br>
						<img src="./image/EAC19_Ex_mdr.jpg" style="display:block;width:50%;position:relative;margin-right:auto;margin-left:auto;" alt="의료기기 등록증">
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC21_Ex_mdr.jpg" alt="의료기기 등록 Class 분류" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC22_Ex_mdr.jpg" alt="의료기기 등록 진행 시험 종류" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC17_Ex_sgr.jpg" alt="의료기기 등록 유효기간" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC23_Ex_mdr.jpg" alt="의료기기 등록 절차" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC18_Ex_sgr.jpg" alt="의료기기 등록 제출 서류" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/eac_mark09.jpg" alt="의료기기 등록 확인" style="display:block;width:85%;position:relative;margin-right:auto;margin-left:auto;">
					</dt>
					<dd>
