	...
	<div class="business_type5" class="area">
		...
		<ul>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/02_1.jpg" alt="GOST R 인증서류" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/eac_mark11.jpg" alt="인증 절차" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
