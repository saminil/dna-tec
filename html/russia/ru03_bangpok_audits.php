	...
	<div class="business_type5" class="area">
		...
		<ul>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC03_Ex_CoC.jpg" alt="TRCU EAC Ex 대상 품목" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC02_Ex_CoC.png" alt="TRCU EAC Ex 방폭인증 유형" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC04_Ex_CoC.jpg" alt="TTRCU EAC Ex 방폭인증 유효기간" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC05_Ex_CoC.jpg" alt="TRCU EAC Ex 방폭인증 스킴" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC06_Ex_CoC.png" alt="TRCU EAC Ex 방폭인증 절차" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC07_Ex_CoC.jpg" alt="TRCU EAC Ex 방폭인증 제출 서류" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
			...
			<li>
				<dl>
					<dt>
						<img src="./image/EAC08_Ex_CoC.jpg" alt="마킹 요구사항" style="width:95%;margin-left:auto;margin-right:auto;">
					</dt>
					<dd>
