<?php 	
	...
	$tmenu2_ = "보건 & 의료기기"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "보건 & 의료기기"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">보건 &amp; 의료기기 인증</span></h1>
            <div class="sub_txt">
                <p><strong class="point_b1">ISO 13485 의료기기 품질경영시스템</strong></p>
				<p>의료기기의 설계 및 개발, 생산, 설치 및 부가서비스를 제공하는 조직의 품질 경영 시스템에 대한 요구사항을 규정한 규격입니다.</p><br><br>
				<p><strong class="point_b1">ISO 15378 의료포장재 제조사 품질경영시스템</strong></p>
				<p>
				...
				<p><strong class="point_b1">ISO 14155 의료기기 임상조사계획 자발적 평가</strong></p>
				<p>
				    ‘인체 대상 의료기기 임상시험에 대한 국제표준 – GCP(Good Clinical Practice)’으로 임상 시험 원칙, 수행 절차 및 수집할 정보에 대한 가이드라인을 제공합니다.
				</p>
            </div>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/manage/image/ISO%2013485_01.jpg" style="width: 70%"></p>
	    </div>
