<?php 	
	...
	$tmenu2_ = "품질/환경/안전보건"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "품질/환경/안전보건"; //커스텀페이지의 타이틀을 입력합니다.
...
<div class="content_wrap">
    <div class="business_type2"><!-----class="company 시작-------->
        <div class="page_title">
            <h1 class="sub_tit"><span class="fc_pointer">품질/환경/안전보건 인증</span></h1>
            <div class="sub_txt">
                <p><strong class="point_b1">ISO 9001 품질경영시스템</strong></p>
				<p>기업의 품질 경영 시스템을 위한 규격으로, 조직의 형태, 규모 또는 제공되는 제품 및 서비스에 관계없이 모든 조직에 적용될 수 있습니다.</p><br><br>
				<p><strong class="point_b1">ISO 14001 환경경영시스템</strong></p>
				<p>
				    환경경영시스템(EMS)를 위한 국제 규격으로 환경경영시스템에 대한 원칙, 시스템 및 지원 기술에 관한 일반 가이드라인과 함께 환경경영시스템 수립, 시행, 유지 및 개선과 같은 이슈들을 다룹니다.
				</p><br><br>
				<p><strong class="point_b1">ISO 45001 안전보건경영시스템</strong></p>
				<p>
				    기존의 OHSAS 18001:2007 규격이 2018년 ISO 45001로 대체되었습니다. 이는 ISO 9001 및 14001 관리 시스템과 호환되는 산업 보건 및 안전 관리 시스템을 통해 보건 및 안전 관리 책임을 관리하기 위한 프레임워크를 제공합니다.
				</p>
            </div>
            <p class="logo_location"><img src="http://igcert.org/theme/rt_igcert/manage/image/ISO_9001_01.jpg" style="width: 70%"></p>
	    </div>
