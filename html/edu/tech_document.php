<?php 	
	...
	$tmenu2_ = "기술문서번역"; //	이 페이지가 3차 메뉴일 경우 theme.menu.php 에서 세팅한 이 페이지의 2차메뉴명을 입력합니다. 3차메뉴가 아니라면 값을 입력하지 않습니다.
	$g5['title'] = "기술문서번역"; //커스텀페이지의 타이틀을 입력합니다.
...
<div id="sub_tit">
    <div class="path">
        ...
        <!----인증서비스(러시아) 페이지 연결-------->
        <?php if($tmenu2_){?><li><a href="tech_document.php"><?php echo $tmenu2_?></a></li><?php }?>
        <!----러시아 페이지 연결-------->
...
<div class="content_wrap">
    <div class="page_title">
        <h1 class="sub_tit"><span class="fc_pointer">기술문서번역</span>&nbsp; RUS TEST PACIFIC</h1>
        <h2 class="sub_txt">지도서비스 | 기술문서 번역</h2>
    </div>
...
<!----게시판  프로그램 시작 ------------>
 ...
 <?php echo latest('theme/daon_basic', "technologies", 5, 25);        ?>
