...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="mobile_no"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  </a></th>
        </tr>
        </thead>
        <tbody>
        <?php
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <td class="td_num2 td_qna">
				<?php  if ($list[$i]['is_notice']) { ?> 
					<span class="qnaIco qnaIco1"><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>공지사항</span></span>
				<?php } else {?>
					<?php if ($list[$i]['comment_cnt']) { ?>
					<span class="qnaIco qnaIco2"><i class="fa fa-check" aria-hidden="true"></i> <span>답변완료</span></span>
					<?php } else {?>
            ...
            <td class="td_datetime mobile_no"><?php echo $list[$i]['datetime2'] ?></td>
