...
-->        
    ...
    <strong>
     <?php if ($view['wr_10']=="견적완료") { ?><div style="padding:0px 0 0 0;width:100px;height:20px;background:#FF3061;color:#fff;font-weight:bold;text-align:center;">견적완료</div> 
	 <?php }elseif($view['wr_10']=="견적중"){ ?><div style="padding:0px 0 0 0;width:100px;height:20px;background:#5AD103;color:#fff;font-weight:bold;text-align:center;">견적중</div>
	 <?php }elseif($view['wr_10']=="견적접수"){ ?><div style="padding:0px 0px 0 0;width:100px;height:20px;background:#878ED3;color:#fff;font-weight:bold;text-align:center;">견적접수</div>
	 <?php } ?>
     </strong>       
     ...
     <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="sound_only">HS코드</span> <strong>&#10054; HS코드:<?php echo $view['wr_1'] ?></strong>
        <span class="sound_only">모델명</span><strong>&#10054; 모델명:<?php echo $view['wr_2'] ?></strong>
        <span class="sound_only">휴대폰</span><strong>&#10054; 휴대폰:<?php echo $view['wr_3'] ?></strong>
        <span class="sound_only">담당자이름</span><strong>&#10054; 담당자이름:<?php echo $view['wr_4'] ?></strong>
        <span class="sound_only">이메일</span><strong>&#10054; 이메일:<?php echo $view['wr_email'] ?></strong>
        <span class="sound_only">문의사항</span><strong>&#10054; 문의사항:<?php echo $view['wr_5'] ?></strong>
        <span class="sound_only">연락받기 원하시는 방법</span><strong>&#10054; 연락받기 원하시는 방법 :&nbsp;<?php echo $view['wr_11'] ?></strong>

        <span class="sound_only">조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i>열람횟수:<?php echo number_format($view['wr_hit']) ?>회</strong>
