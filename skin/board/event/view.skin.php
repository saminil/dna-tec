...
<article id="bo_v" style="width:<?php echo $width; ?>" class="event">
    <header>
        <h2 id="bo_v_title">
            <span class="bo_v_tit">
            <?php
			...
			<section id="bo_v_info">
				<span class="sound_only">이벤트 설명</span> <p class="event_basic"><?php echo $view['wr_8'] ?></p>
				<span class="sound_only">이벤트 기간</span> <p class="event_date"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo $view['wr_9']." ~ ".$view['wr_10'] ?></p>
			</section>
        </h2>
		<!-- 게시물 상단 버튼 시작 { -->
	    <div id="bo_v_top">
