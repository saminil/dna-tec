...
<section id="bo_w">
    ...
    <div class="bo_w_link write_div">
        <label for="wr_link<?php echo $i ?>"><i class="fa fa-image" aria-hidden="true"></i><span class="sound_only">썸네일 용 유튜브 아이디<?php echo $i ?></span></label>
        <input type='text' name='wr_2' value='<?php echo $write['wr_2'] ?>' class="frm_input full_input" placeholder="썸네일 용 Youtube ID 입력">
    </div>
    <?php } ?>
