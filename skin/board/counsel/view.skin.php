...
$view['wr_tel']			= $view['wr_1']; //전화번호
$view['wr_hp']			= $view['wr_2']; //모바일
$view['wr_comname']		= $view['wr_4']; //업체명
list($view['wr_zip'], $view['wr_addr1'], $view['wr_addr2'], $view['wr_addr3'], $view['wr_addr_jibeon']) = explode('|', $view['wr_3']); //주소
			...
			<div class="tb_wt">
				<table style="border-bottom: 1px solid #ddd;">
					...
					<tbody>
						...
						<?php if ($is_comname) { ?>
						<tr>
							<th scope="row"><label for="wr_comname">업체명</label></th>
							<td>
								<div class="hidden_div">업체명</div>
								<?php echo $view['wr_comname']; ?>
							</td>
						</tr>
						<?php } ?>
						...
						<?php if ($is_tel) { ?>
						<tr>
							<th scope="row"><label for="reg_wr_tel">전화번호</label></th>
							<td>
								<div class="hidden_div">전화번호</div>
								<?php echo $view['wr_tel']; ?>
							</td>
						</tr>
						<?php } ?>
						...
						<?php if ($is_hp) { ?>
						<tr>
							<th scope="row"><label for="reg_wr_hp">휴대폰번호</label></th>
							<td>
								<div class="hidden_div">휴대폰번호</div>
								<?php echo $view['wr_hp']; ?>
							</td>
						</tr>
						<?php } ?>
						...
						<?php if ($is_addr) { ?>
						<tr>
							<th scope="row"><label for="reg_wr_addr">주소</label></th>
							<td>
								<div class="hidden_div">주소</div>
								<?php echo $view['wr_addr1']; ?> <?php echo $view['wr_addr2']; ?>
							</td>
						</tr>
						<?php } ?>
					</tbody>
		...
		<div class="btn-group">
			...
			<?php if ($write_href) { ?>
				<a href="<?php echo $write_href ?>" class="btn btn-color btn-sm">
					<i class="fa fa-pencil"></i><span class="hidden-xs"> 상담하기</span>
				</a>
			<?php } ?>
			<?php } ?>
