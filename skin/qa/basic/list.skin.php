...
<div id="bo_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="mobile_no">등록일</th>
            <th scope="col">상태</th>
        </tr>
        </thead>
        <tbody>
        ...
        <tr class="<?php echo $lt_class ?>">
            ...
            <?php } ?>
            <td class="td_num mobile_no"><?php echo $list[$i]['num']; ?></td>
            <td class="td_subject">
            ...
            <td class="td_name mobile_no"><?php echo $list[$i]['name']; ?></td>
            <td class="td_date mobile_no"><?php echo $list[$i]['date']; ?></td>
