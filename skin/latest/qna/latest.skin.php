    ...
    <?php for ($i=0; $i<$list_count; $i++) {  ?>      
		<li class="basic_li">
			...
			<?php if (!$list[$i]['is_notice']) { ?>
				...
				<span class="qnaIco qnaIco2"><i class="fa fa-check" aria-hidden="true"></i></span>
				<?php } else {?>
				<span class="qnaIco qnaIco3"><i class="fa fa-spinner" aria-hidden="true"></i></span>
				<?php } ?>
			<?php } ?>
			<?php			
				if ($list[$i]['ca_name']) echo "<span class=\"catg\">[".$list[$i]['ca_name']."]</span>";
